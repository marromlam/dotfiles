...
--- Creates a custom alias for some paths
local function alias_for_this_directory(directory)
...
local function filename(ctx)
  ...
  local new_dir, env = alias_for_this_directory(dir)
